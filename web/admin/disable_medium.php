<?php
    ...
    $medium = $_GET['id'];
    $conn->query("UPDATE login set active=0 WHERE medium_id=$medium AND user_type=2");
    ...
    $conn->query("UPDATE class set active=0 WHERE medium_id=$medium");
    $query = "UPDATE medium set active=0 where id=$medium";
