<?php
    ...
    if(is_numeric($search)){
        $query = "SELECT first_name,last_name,id,class_id,medium_id from login where mobile LIKE '%$search%'";
        ...
        if(filter_var($search, FILTER_VALIDATE_EMAIL)) {
            $query = "SELECT first_name,last_name,id,class_id,medium_id from login where email LIKE '%$search%'";
            $result = $conn->query($query);
            while($row = $result->fetch_array()){
                $class_name = $conn->query("select name from class where id=".$row['class_id']);
                $class_name = $class_name->fetch_array();
